...
<!DOCTYPE html>
	...
	<html>
		...
		<head>
			<title>Fiche hors-forfaitaire</title>
			<meta charset="UTF-8">
...
<br />
  ...
  <form id="formulaire" action="" method="post">
    ...
    <h4>Veuillez remplir la fiche hors-forfaitaire.</h4>
    <fieldset>
      <p id="date">Date :</p>
    ...
    <fieldset>
      <input placeholder="Veuillez afficher votre montant" type="number" tabindex="2" required>
    </fieldset>
    <p id="libelle">Libelle :</p>
    <fieldset>
      <input placeholder="Entrez votre libelle..." type="text" tabindex="1" required>
    </fieldset>

    <fieldset>
      <button name="Envoyer" type="submit" id="envoyer" data-submit="...Envoyer">Envoyer</button>
    </fieldset>
